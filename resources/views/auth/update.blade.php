    ...
    <x-auth-card>
        ...
        <form method="POST" action="{{ route('update.profile') }}" enctype="multipart/form-data">
          ...
          <div class="mt-4">
            ...
            <div class="mt-4">
                <x-label for="password_confirmation" :value="__('Avater')" />

                <x-input id="avater" class="block mt-1 w-full"
                                type="file"
                                name="avater" />
            </div>
            <div class="mt-4">
                <img class="w-8" src="{{ ENV('ASSET_LINK_CUSTOMER').'storage/'.Auth::user()->avater }}" alt="">
            </div>
